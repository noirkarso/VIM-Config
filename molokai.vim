...
if s:molokai_original == 1
   hi Normal          guifg=#ffff00  guibg=#272822
   ...
   hi Normal          guifg=#ffff00 guibg=#1B1D1E
...
if &t_Co > 255
   if s:molokai_original == 1
      ...
      hi Normal       ctermfg=195 ctermbg=none
      hi CursorLine               ctermbg=237   cterm=none
      hi CursorLineNr ctermfg=208               cterm=none
   endif
   ...
   hi Identifier      ctermfg=226               cterm=none
   ...
   hi Tag             ctermfg=161
   hi Title           ctermfg=202 cterm=bold
   hi Todo            ctermfg=231 ctermbg=232   cterm=bold
   hi Typedef         ctermfg=81
   hi Type            ctermfg=81                cterm=none
   hi Underlined      ctermfg=117               cterm=underline
   ...
   hi htmlTagName ctermfg=33 cterm=bold guifg=#9effff guibg=NONE gui=NONE
   hi htmlArg ctermfg=214 guifg=#9effff guibg=NONE gui=NONE
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       hi Normal       ctermfg=226 ctermbg=234
